...
public class FunFactSeeder {
    ...
    public void seedFunFact(ContextRefreshedEvent event) {
        if (funFactService.getAll().size() == 0) {
            ...
            funFactService.addFunFact("Pigs are navigators: they can find their way home over large distances. They can often trot long distances and can reach up to 17 km per hour running.");
            funFactService.addFunFact("The average fully grown pig can weigh between 135 and 315 kilo. However the world record for the heaviest pig has not been beaten since 1933. Big Bill from Tennessee weighed in at 1157 kilo. Now that is a big pig.");
            ...
            funFactService.addFunFact("Rabbits can hop and BOY can they also jump! In fact, rabbits can jump to impressive heights and distances….a little over 90 cm high and a whopping 3 m long!");
