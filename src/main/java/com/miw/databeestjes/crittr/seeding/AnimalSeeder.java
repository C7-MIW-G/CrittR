...
public class AnimalSeeder {
    ...
    public void seedAnimal(ContextRefreshedEvent event) {
        if (animalService.getAll().size() == 0) {
            ...
            animalService.addNewAnimal("Sheep", "Sandy", LocalDate.parse("2016-02-17"), "", getPicture("sheep1.jpg"));
            ...
            animalService.addNewAnimal("Sheep", "Shaun", LocalDate.parse("2015-05-05"), "", getPicture("sheep4.jpg"));
            ...
            animalService.addNewAnimal("Deer", "Dudley", LocalDate.parse("2014-03-14"), "", getPicture("deer1.jpg"));
            ...
            animalService.addNewAnimal("Cow", "Carol", LocalDate.parse("2016-04-15"), "", getPicture("cow2.jpg"));
            ...
            animalService.addNewAnimal("Pig", "Pepper", LocalDate.parse("2022-02-28"), "", getPicture("pig3.jpg"));
            ...
            animalService.addNewAnimal("Chicken", "Charlie", LocalDate.parse("2019-04-21"), "", getPicture("chicken1.jpg"));
