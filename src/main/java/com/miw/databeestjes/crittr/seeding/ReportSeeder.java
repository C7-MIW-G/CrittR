...
public class ReportSeeder {
    ...
    public void seedReport(){
        ...
        if(reportService.getAll().isEmpty()) {
            ...
            reportService.addNew("Bit me", animalService.findByAnimalId(1).get(), "Gary", "Goat", "I just wanted to pet it", allUsers.get(5), ReportStatus.NEW);
            reportService.addNew("Limps", null, "", "Deer", "", allUsers.get(9), ReportStatus.CLOSED);
            reportService.addNew("Kicked me", animalService.findByAnimalId(11).get(), "Danny", "Donkey", "I was trying to feed it and it kicked me", allUsers.get(7), ReportStatus.DISCARDED);
